...
internal static class Program
{
    ...
    {
        string managed = args.Length > 0 ? args[0] : @"G:\SteamLibrary\steamapps\common\A Dance of Fire and Ice\A Dance of Fire and Ice_Data\Managed";
    ...
    private static void Run()
    {
        ...
        try
        {
            ...
            planet.Body = () => player.marginTracker.AddHit(HitMargin.Perfect);
            planet.SwitchChosen();
            Expect(GaugeRuntime.Charges.Count == 1 && GaugeRuntime.Charges[0] == HitMargin.Perfect, "native perfect");
            ...
            for (int i = 0; i < 4; i++) planet.SwitchChosen();
            ...
            try { planet.SwitchChosen(); } catch (InvalidOperationException e) { Expect(e.Message == "switch", "switch exception preserved"); }
            ...
            planet.Body = () => player.Die();
            try { planet.SwitchChosen(); } catch (InvalidOperationException e) { Expect(e.Message == "die", "die exception preserved"); }
            ...
            VanillaJudgementObservation.Record(player.marginTracker, HitMargin.Perfect);
            Expect(VanillaJudgementObservation.End(ref inner) == HitMargin.Perfect, "inner observation");
            ...
            Expect(VanillaJudgementObservation.End(ref fresh) == HitMargin.Perfect, "reset invalidates old finalizer");
